...
import com.magnet.parse_generate_xml.udp.BTSQuery;
import com.magnet.socket_service.CommunicationService;
...
import com.magnet.socket_service.EventBusMsgSendUDPBroadcastMsg;
...
import static com.magnet.femto.BcastCommonApi.isServiceRunning;
...
//    private ScanDeviceTool scanDeviceTool = new ScanDeviceTool();
    ...
    protected void initView() {
        if (!isServiceRunning(mContext, "com.magnet.socket_service.CommunicationService")){
...
//        iv_rotate.clearAnimation();
        ...
        if (((ProxyApplication)mContext.getApplicationContext()).getCurSocket() == null &&
            ...
            intent.setClassName("com.magnet.FemtoController", "com.magnet.FemtoController.FunActivity");
...
//            startActivity(intent);
    ...
    private void startAutomaticTestActivity(String ip, int port) {
        Intent intent = new Intent();
        intent.setClassName("com.magnet.FemtoController", "com.magnet.test.AutomaticTestActivity");
