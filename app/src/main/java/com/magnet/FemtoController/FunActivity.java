...
import com.magnet.R;
import com.magnet.config.GSM_Fragment;
import com.magnet.config.General_Fragment;
import com.magnet.config.LTE_Fragment;
import com.magnet.config.Network_Fragment;
import com.magnet.config.Switch_Fragment;
import com.magnet.config.UMTS_Fragment;
import com.magnet.custom_view.CircleMenuLayout;
import com.magnet.custom_view.OneBtnHintDialog;
import com.magnet.custom_view.RecordOnClick;
import com.magnet.femto.FragmentAdjacentCell;
import com.magnet.femto.FragmentBcastHistory;
import com.magnet.femto.FragmentBcastStart;
import com.magnet.femto.FragmentCellScan;
import com.magnet.config.FragmentSetConfig;
import com.magnet.femto.FragmentTarget;
import com.magnet.fragments.RevealAnimationBaseFragment;
import com.magnet.log.Local_Fragment;
import com.magnet.log.Remote_Fragment;
import com.magnet.parse_generate_xml.Status;
import com.magnet.status.Basic_Fragment;
import com.magnet.status.Cell_Fragment;
import com.magnet.status.HwMonitor_Fragment;
import com.magnet.status.Sniffer_Fragment;
import com.magnet.status.Wifi_Fragment;
import com.magnet.system.Upgrade_Fragment;
import com.magnet.test.Terminal_Fragmen;
...
public class FunActivity extends BaseActivity {
        ...
        if (((ProxyApplication)mContext.getApplicationContext()).getCurSocket() == null && pos != 2 && pos != 5) {
            connHintDialog.setListener(new OneBtnHintDialog.BtnClickListener() {
                ...
                public void onBtnClick(View v) {
                    ...
                    intent.setClassName("com.magnet.FemtoController", "com.magnet.FemtoController.FemtoListActivity");
    ...
    private void onConfigClicked(){
        ...
        fragments.add(new com.magnet.config.Wifi_Fragment());
