...
import com.magnet.BlueTooth.EventBusTukTukMsg;
import com.magnet.BlueTooth.tukTukService;
import com.magnet.R;
import com.magnet.no_http.download.DownloadListener;
import com.magnet.no_http.download.DownloadQueue;
import com.magnet.no_http.download.DownloadRequest;
import com.magnet.no_http.rest.OnResponseListener;
...
import com.magnet.utils.StatusBarCompat;
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.tuktuk_enter:
                //检查蓝牙服务是否打开
//                if (!isServiceRunning(mContext, "com.magnet.BlueTooth.tukTukService")){//检测蓝牙服务是否启动
    ...
    public void TTConnectStatus(EventBusTukTukMsg eventBusTukTukMsg) {
        switch (eventBusTukTukMsg.getAction()) {
            case EventBusTukTukMsg.BT_STATUS_ALREADY_CONNECT:
                Intent  intent = new Intent();
                intent.setClassName("com.magnet.FemtoController", "com.magnet.BlueTooth.TTConfigActivity");
                startActivityWithAnimation(intent);
                break;
            case EventBusTukTukMsg.BT_STATUS_NOCONNECT:
                intent = new Intent();
                intent.setClassName("com.magnet.FemtoController", "com.magnet.BlueTooth.tukTukActivity");
                startActivityWithAnimation(intent);
                break;
            default:
                break;
