...
import com.magnet.dialog.DialogSendSMS;
import com.magnet.dialog.DialogTargetRedirect;
...
import com.magnet.parse_generate_xml.send_sms.SendSmsReq;
import com.magnet.parse_generate_xml.send_sms.SendSmsRes;
import com.magnet.parse_generate_xml.silent_call.SilentCallReq;
...
import com.magnet.parse_generate_xml.target_redirect.TargetRedirectReq;
                            ...
                            .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if(Build.VERSION.SDK_INT>=24) {
                                        Uri apkUri = FileProvider.getUriForFile(mContext, "com.magnet.fileprovider",
